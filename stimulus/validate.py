...
def run_validation(win: visual.Window, config: dict):
    ...
    # prepare instruction
    textstim = visual.TextStim(win, text="", height=config["instruction_text"]["height"], units=config["instruction_text"]["units"], color=config["instruction_text"]["color"], wrapWidth=9999.)
